...
public:
    ...
    virtual YTable *            createTable             ( YWidget * parent, YTableHeader * header_disown, bool multiSelection ) = 0;
    virtual YTable *            createTable             ( YWidget * parent, YTableHeader * header_disown, YTableMode mode = YTableSingleLineSelection ) = 0;
